...
final int CONTROL_COLUMN_COUNT = 7;
...
final float INPUT_DEAD = 15;
final float INPUT_MAX_SPEED = 16;
final float INPUT_SENSOR_ABS_LIMIT = 1400;
final float INPUT_MAX_SMOOTH_STEP = 260;
final float INPUT_VELOCITY_ALPHA = 0.62;
final float INPUT_AXIS_MAX = 1024.0;
final float INPUT_Y_SPEED_SIGN = -1.0;
final float INPUT_SMOOTH_ALPHA = 0.58;
